        ...
        aksiBiaya.forEach(data => {
            $("#biaya-table tbody").append(`<tr>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-danger btn-sm btnDelete" data-id="${data.id_biaya}" data-type="biaya" onclick="return confirm('Yakin ingin menghapus data ini?')">Hapus</button>
                </td>
            </tr>`);
        });
    }
        ...
        aksiBarang.forEach(data => {
            $("#barang-table tbody").append(`<tr>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-danger btn-sm btnDelete" data-id="${data.id_barang}" data-type="barang" onclick="return confirm('Yakin ingin menghapus data ini?')">Hapus</button>
                </td>
            </tr>`);
        });
    }
