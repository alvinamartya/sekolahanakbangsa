                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item <?php echo (strtolower($this->uri->segment(1)) == 'dashboard' || strtolower($this->uri->segment(1)) == '' ? 'active selected' : '') ?>">
                            <a class="sidebar-link <?php echo (strtolower($this->uri->segment(1)) == 'dashboard' || strtolower($this->uri->segment(1)) == '' ? 'active' : '') ?>" href="<?php echo site_url("dashboard/relawan") ?>" aria-expanded="false">
                        ...
                        <?php if ($active == true) { ?>
                            ...
                            <li class="sidebar-item <?php echo (strtolower($this->uri->segment(1)) == 'siswa' || strtolower($this->uri->segment(1)) == '' ? 'active selected' : '') ?>">
                                <a class="sidebar-link <?php echo (strtolower($this->uri->segment(1)) == 'siswa' || strtolower($this->uri->segment(1)) == '' ? 'active' : '') ?>" href="<?php echo site_url('siswa') ?>" aria-expanded="false">
                            ...
                            <li class="sidebar-item <?php echo (strtolower($this->uri->segment(1)) == 'aksi' || strtolower($this->uri->segment(1)) == '' ? 'active selected' : '') ?>">
                                <a class="sidebar-link <?php echo (strtolower($this->uri->segment(1)) == 'aksi' || strtolower($this->uri->segment(1)) == '' ? 'active' : '') ?>" href="<?php echo site_url('aksi') ?>" aria-expanded="false">
                            ...
                            <li class="sidebar-item <?php echo (strtolower($this->uri->segment(1)) == 'kebutuhan-tahunan' || strtolower($this->uri->segment(1)) == 'kebutuhan_tahunan' || strtolower($this->uri->segment(1)) == '' ? 'active selected' : '') ?>">
                                <a class="sidebar-link <?php echo (strtolower($this->uri->segment(1)) == 'kebutuhan-tahunan' || strtolower($this->uri->segment(1)) == 'kebutuhan_tahunan' || strtolower($this->uri->segment(1)) == '' ? 'active' : '') ?>" href="<?php echo site_url('kebutuhan-tahunan') ?>" aria-expanded="false">
