                    ...
                    <ul id="sidebarnav">
                        <li	class="sidebar-item <?php echo ($this->uri->segment(1) == 'dashboard' || $this->uri->segment(1) == '' ? 'active' : '') ?>">
							<a class="sidebar-link <?php echo ($this->uri->segment(1) == 'dashboard' || $this->uri->segment(1) == '' ? 'active' : '') ?>"
                                href="<?php echo site_url("dashboard/relawan") ?>" aria-expanded="false">
						...
						<li class="sidebar-item <?php echo ($this->uri->segment(1) == 'aksi' || $this->uri->segment(1) == '' ? 'active' : '') ?>">
                            <a class="sidebar-link <?php echo ($this->uri->segment(1) == 'aksi' || $this->uri->segment(1) == '' ? 'active' : '') ?>" href="<?php echo site_url('aksi') ?>"
                                aria-expanded="false">
                                <i class="fas fa-seedling"></i><span class="hide-menu">Aksi</span>
                            </a>
                        </li>
                        ...
                        <li class="sidebar-item <?php echo ($this->uri->segment(1) == 'karyawan' || $this->uri->segment(1) == '' ? 'active' : '') ?>">
                            <a class="sidebar-link <?php echo ($this->uri->segment(1) == 'karyawan' || $this->uri->segment(1) == '' ? 'active' : '') ?>" href="<?php echo site_url('karyawan') ?>"
                                aria-expanded="false">
                                <i class="fas fa-calendar-alt"></i><span class="hide-menu">Kebutuhan Tahunan</span>
                            </a>
						</li>
                    </ul>
                </nav>
