...
<head>
    ...
    <title>Register - Sekolah Anak Bangsa</title>
            ...
            <div class="w-50">
                ...
                <form action="<?= site_url("register/register_donatur") ?>" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?php echo (form_error('nama_donatur') != null ? 'is-invalid' : '') ?>" name="nama_donatur" value="<?php echo set_value('nama_donatur'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control <?php echo (form_error('no_telepon') != null ? 'is-invalid' : '') ?>" name="no_telepon" value="<?php echo set_value('no_telepon'); ?>">
                        <div class="invalid-feedback"><?php echo form_error('no_telepon'); ?></div>
                    </div>
                    <div class="form-group">
                        <label for="email">Email</label>
                        <input type="text" class="form-control <?php echo (form_error('email_donatur') != null ? 'is-invalid' : '') ?>" name="email_donatur" value="<?php echo set_value('email_donatur'); ?>">
                        <div class="invalid-feedback"><?php echo form_error('email_donatur'); ?></div>
                    </div>
                    <div class="form-group">
                        <label for="nama_pengguna">Nama Pengguna</label>
                        <input type="text" class="form-control <?php echo (form_error('username') != null ? 'is-invalid' : '') ?>" name="username" value="<?php echo set_value('username'); ?>">
                        <div class="invalid-feedback"><?php echo form_error('username'); ?></div>
                    </div>
                    <div class="form-group">
                        <label for="password">Kata Sandi</label>
                        <input type="password" class="form-control <?php echo (form_error('password') != null ? 'is-invalid' : '') ?>" name="password" value="<?php echo set_value('password'); ?>">
